...
public class StandardBoardMaker implements IBoardMaker {
    ...
    public BoggleBoard makeBoardWithDice(int rows) {
    	ArrayList<Cube> dice = myDice16;
        if (rows*rows > 16) {
            dice = myDice25;
        }
        String[] letterList = new String[rows*rows];
        ...
        BoggleBoard returnable = new BoggleBoard(letterList);
        returnable.setDice(dice);
